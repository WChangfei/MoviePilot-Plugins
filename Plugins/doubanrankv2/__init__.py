...
class DoubanRankV2(_PluginBase):
    ...
    # 作者主页
    author_url = "https://github.com/WChangfei/MoviePilot-Plugins"
    # 插件配置项ID前缀
    ...
    def init_plugin(self, config: dict = None):
        ...
        if config:
            ...
            self._rsshub = config.get("rsshub") or "https://rsshub.ddsrem.com/"
        ...
        if self._enabled or self._onlyonce:
            if self._onlyonce:
                ...
                logger.info("豆瓣榜单订阅服务V2启动，立即运行一次")
                    ...
                    'content': [
                        {
                            ...
                            'events': {
                                'click': {
                                    ...
                                    'method': 'get',
                                    'params': {
                                        'key': f"doubanrankv2: {title} (DB:{doubanid})",
